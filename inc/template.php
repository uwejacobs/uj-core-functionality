...
function ujcore_getFullLocationAddress($atts) {
...
add_shortcode("cts_full_location_address", "ujcore_getFullLocationAddress");
...
function ujcore_getFullContacts($atts) {
...
add_shortcode("cts_full_contacts", "ujcore_getFullContacts");
...
function ujcore_getTwitterIcon($atts) {
...
add_shortcode("cts_social_twitter", "ujcore_getTwitterIcon");

function ujcore_getLinkedInIcon($atts) {
...
add_shortcode("cts_social_linkedin", "ujcore_getLinkedInIcon");

function ujcore_getNextdoorIcon($atts) {
...
add_shortcode("cts_social_nextdoor", "ujcore_getNextdoorIcon");

function ujcore_getSocialIcons($atts) {
...
add_shortcode("cts_social", "ujcore_getSocialIcons");
