...
if (!function_exists('ujcfe_formatEmail')) {
	function ujcfe_formatEmail($email) {
		if (!empty($email)) {
			return '<i class="fas fa-envelope fa-fw me-2"></i><a href="mailto:' . esc_attr($email) . '">'. esc_html($email) . '</a>';
		}
